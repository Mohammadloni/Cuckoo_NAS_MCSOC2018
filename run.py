...
if __name__ == '__main__':
    ...
    cgp = CGP(cfg, children=50)
    cgp.run(e, max_epochs=1024, save_best='/home/user1/loni/cgp-cnn-design-master3/tmp/parent.pkl')
